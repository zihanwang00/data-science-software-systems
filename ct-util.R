...
setwd("~/Desktop/Year_2_Sem_1/SDS620/midterms/data-science-software-systems-main/BIS 620 Midterm/BIS620_Midterm")
#setwd("~/Desktop/Year_2_Sem_1/SDS620/midterms/data-science-software-systems-main/BIS 620 Midterm")
...
#' 
#' 
#' With Feature 5 included in as well
...
#   filter(!removed) %>%
#   group_by(name) %>%
#   summarise(id = toString(id), nct_id = toString(nct_id))
# 
# names_countries <- filtered_countries$name
# 
